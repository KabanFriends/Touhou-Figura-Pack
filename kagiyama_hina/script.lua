...
models.player_model.all.all2.RightArm:setRot(0, 0, 7)
models.player_model.all.all2.LeftArm:setRot(0, 0, -7)

--setup hand items
local rightitem = models.player_model.all.all2.RightArm:newPart("RightItemPivot")
rightitem:setParentType("RightItemPivot")
rightitem:setPivot(4, 8.5, -1)
rightitem:setScale(unscale)

local leftitem = models.player_model.all.all2.LeftArm:newPart("LeftItemPivot")
